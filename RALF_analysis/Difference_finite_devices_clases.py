...
from Lead_Field_Matrix import lead_field_matrix, exponential_multicomponent,ker_R_si
# from Features_BF_Mesh import lead_field_matrix_coil_fast3_Hv_fn,lead_field_matrix_coil_point_sensor, lead_field_matrix_coil_fast2, lead_field_matrix_coil_fast3, lead_field_matrix_coil_fast3_Hv, get_coil_points_perpendicular,get_coil_points_axis,Mesh_Features, Basis_function_List,compute_gradients,volumen_element,mask_for_nodes, lead_field_matrix2,mask_for_elements,lead_field_matrix_coil,ker_R_si_coil,kernel_coil,coil_magnetic_field,get_upward_coil_points
from algorithm_solution_FL import DG_algorithm,bregman_algorithm_fused_lasso, bregman_algorithm_fused_lasso_2,bregman_algorithm_fused_lasso_3, DG_algorithm_v2


from Lead_Field_Matrix import lead_field_matrix, exponential_multicomponent
# from Features_BF_Mesh import coil_magnetic_field_total_fast, Mesh_Features, Basis_function_List,compute_gradients,volumen_element,mask_for_nodes,lead_field_matrix2,mask_for_elements,lead_field_matrix_coil_fast
from algorithm_solution_FL import DG_algorithm,bregman_algorithm_fused_lasso, bregman_algorithm_fused_lasso_2,bregman_algorithm_fused_lasso_3, DG_algorithm_v2,DG_algorithm_conjugated_gradient_method
import time
